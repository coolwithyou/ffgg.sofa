...
export function PublishStatusCard({ mode = 'public-page' }: PublishStatusCardProps) {
  ...
  const canSave = hasSaveChanges && !isSaving;
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-lg border border-border bg-muted/30 p-3">
          ...
          <div className="mb-2 flex items-center justify-between">
            <div className={`flex items-center gap-1.5 text-xs ${saveStatusDisplay.className}`}>
            ...
            <div className="flex items-center gap-2">
              <Label htmlFor="auto-save-toggle" className="text-xs text-muted-foreground cursor-pointer">
                자동저장
              </Label>
              <Switch
                id="auto-save-toggle"
          ...
          <div className="flex flex-col gap-2">
            ...
            {canDeploy ? (
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 rounded-md bg-muted p-2 text-[11px] text-muted-foreground">
